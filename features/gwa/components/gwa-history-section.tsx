...
import { EditIcon, EyeIcon, LoaderCircleIcon, Trash2Icon } from "lucide-react"
...
export function GwaHistorySection({
  ...
  records: GwaRecordSummary[]
  isLoading: boolean
  isError: boolean
  errorMessage: string
  onRetry: () => void
  onCreate: () => void
  onView: (record: GwaRecordSummary) => void
  onEdit: (record: GwaRecordSummary) => void
  onDelete: (record: GwaRecordSummary) => void
